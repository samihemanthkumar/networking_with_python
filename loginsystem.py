...
class log:
    ...
    def main3(self):
        ...
        t1 = tk.Text(root, height=1, width=4)
        t1.grid(row=1, column=2)
        b1 = tk.Button(root, text='Show Details', width=15, command=lambda: my_details(t1.get('1.0', END)))
        b1.grid(row=1, column=4)
        search = tk.StringVar()
        l2 = tk.Label(root, textvariable=search, width=30, fg='black')
